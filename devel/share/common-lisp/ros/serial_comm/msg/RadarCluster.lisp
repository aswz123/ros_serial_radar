...
(cl:defmethod cl:initialize-instance :after ((m <RadarCluster>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RadarCluster)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serial_comm-msg:<RadarCluster> is deprecated: use serial_comm-msg:RadarCluster instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <RadarCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_comm-msg:x-val is deprecated.  Use serial_comm-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <RadarCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_comm-msg:y-val is deprecated.  Use serial_comm-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <RadarCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_comm-msg:z-val is deprecated.  Use serial_comm-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <RadarCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_comm-msg:velocity-val is deprecated.  Use serial_comm-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <RadarCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_comm-msg:intensity-val is deprecated.  Use serial_comm-msg:intensity instead.")
  (intensity m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <RadarCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_comm-msg:range-val is deprecated.  Use serial_comm-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'azimuth-val :lambda-list '(m))
(cl:defmethod azimuth-val ((m <RadarCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_comm-msg:azimuth-val is deprecated.  Use serial_comm-msg:azimuth instead.")
  (azimuth m))

(cl:ensure-generic-function 'elevation-val :lambda-list '(m))
(cl:defmethod elevation-val ((m <RadarCluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_comm-msg:elevation-val is deprecated.  Use serial_comm-msg:elevation instead.")
  (elevation m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RadarCluster>)))
  ...
  "0840e87e925ffcb716d5163155ce63c6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RadarCluster)))
  "Returns md5sum for a message object of type 'RadarCluster"
  "0840e87e925ffcb716d5163155ce63c6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RadarCluster>)))
  ...
  (cl:format cl:nil "# 单个雷达点消息~%float64 x          # X坐标 (m)~%float64 y          # Y坐标 (m) ~%float64 z          # Z坐标 (m)~%float64 velocity   # 速度 (m/s)~%float64 intensity  # 强度/功率值~%float64 range      # 距离 (m)~%float64 azimuth    # 方位角 (度)~%float64 elevation  # 俯仰角 (度)~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RadarCluster)))
  "Returns full string definition for message of type 'RadarCluster"
  (cl:format cl:nil "# 单个雷达点消息~%float64 x          # X坐标 (m)~%float64 y          # Y坐标 (m) ~%float64 z          # Z坐标 (m)~%float64 velocity   # 速度 (m/s)~%float64 intensity  # 强度/功率值~%float64 range      # 距离 (m)~%float64 azimuth    # 方位角 (度)~%float64 elevation  # 俯仰角 (度)~%~%"))
